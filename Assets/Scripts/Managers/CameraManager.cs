...
public class CameraManager : Singleton<CameraManager>
{
    ...
    private IEnumerator AssignCollider(int cameraIndex)
    {
        ...
        CompositeCollider2D collider =
            GameObject.Find(cameraIndex.ToString()).GetComponent<CompositeCollider2D>();
        AllVirtualCameras[cameraIndex].GetComponent<CinemachineConfiner2D>()
            .m_BoundingShape2D = collider;
