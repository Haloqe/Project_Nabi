...
public class MetalContractUI : MonoBehaviour
{
    ...
    //    var possibleAbilities = PlayerAttackManager.Instance.GetAbilitiesByMetal(metal, true);
    ...
    //    {
    //        _abilityIcons[i].sprite = PlayerAttackManager.Instance.GetAbilityIconSprite(_abilitiesToDisplay[i].Id);
    //    }
    //}
    ...
    //{
    //    PlayerAttackManager.Instance.CollectAbility(_abilitiesToDisplay[index].Id);
